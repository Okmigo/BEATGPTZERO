...
class Rewriter:
    ...
    def __init__(self, model_name: str = "t5-base"):
        ...
        Args:
            model_name (str): The name of the pretrained sequence-to-sequence model
    ...
    def humanize(self, text: str, aggressiveness: float = 0.5) -> Dict[str, Any]:
        """
        Orchestrates the full humanization pipeline, applying a series of
        non-deterministic transformations to the input text.
        """
