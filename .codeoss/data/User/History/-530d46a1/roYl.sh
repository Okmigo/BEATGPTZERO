...
def generate_embeddings():
    ...
    try:
        ...
        if os.path.exists(TMP_DB_PATH):
            print(f"[🧪] File verified at: {TMP_DB_PATH}")
        else:
            print(f"[❌] File not found after creation at: {TMP_DB_PATH}")
...
# 🌐 Testee
curl https://us-central1-corded-nature-462101-b4.cloudfunctions.net/embedAndDeploy
